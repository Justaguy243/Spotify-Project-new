...
async function getSongs(folder) {
  currFolder = folder;
  let a = await fetch(`https://github.com/Justaguy243/Spotify-Project-new/tree/main/${folder}/`);
  ...
  for (const song of songs) {
    ...
    let b = await fetch(`https://github.com/Justaguy243/Spotify-Project-new/blob/main/Author.json`)
...
async function DisplayAlbums() {
  let b = await fetch(`https://github.com/Justaguy243/Spotify-Project-new/tree/main/songs/`);
  ...
  for (let index = 0; index < array.length; index++) {
    ...
    if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
      ...
      let b = await fetch(`https://github.com/Justaguy243/Spotify-Project-new/tree/main/songs/${folder}/info.json`)
      let response2 = await b.json()
